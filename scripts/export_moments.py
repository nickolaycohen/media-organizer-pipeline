...
from constants import MEDIA_ORGANIZER_DB_PATH, TO_BE_CURATED_DIR, STAGING_ROOT, LOG_PATH
...
def main():
    ...
    # Format: <MomentName/file> under the ToBeCurated directory
    # Moved one level up from CURATED_EXPORT_DIR (02-AICurrateList)
    export_root = TO_BE_CURATED_DIR
